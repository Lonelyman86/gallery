...
// dd($path);
        ...
        return redirect('/myalbums/' . $request->input('album_id'))->with('success', 'Photo created');
    }
    ...
    public function destroy($id)
{
    ...
    // Temukan album terkait dengan foto
    $album = $photo->album;

    // Periksa apakah pengguna saat ini adalah pemilik album atau pengunggah foto
    ...
    $photo->delete();
    return redirect('/myalbums/' . $photo->album_id)->with('success', 'Photo deleted');
}
}
